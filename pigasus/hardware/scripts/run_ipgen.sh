...
qsys-generate reset_ip.ip --synthesis=VERILOG --part=1SM21BHU2F53E2VGS1
qsys-generate alt_ehipc2_jtag_avalon.ip --synthesis=VERILOG --part=1SM21BHU2F53E2VGS1
qsys-generate alt_ehipc2_sys_pll.ip --synthesis=VERILOG --part=1SM21BHU2F53E2VGS1
qsys-generate probe8.ip --synthesis=VERILOG --part=1SM21BHU2F53E2VGS1
qsys-generate reset_ip.ip --synthesis=VERILOG --part=1SM21BHU2F53E2VGS1
cd ../../../../../
